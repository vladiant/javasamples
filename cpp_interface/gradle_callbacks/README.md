...
cpp/
  NativeClass.h       # C++ class with Listener interface
  native_jni.cpp      # JNI bridge implementation
java/
  com/example/
    Main.java         # Entry point
    Native.java       # JNI declarations (System.loadLibrary)
    NativeClass.java  # Java wrapper around the C++ object
    NativeListener.java # Java callback interface
```
